...
int init( )
{
    ...
    carre = create_mesh(GL_TRIANGLES);
/*
...
// on peut aussi donner des couleurs differentes aux sommets du triangle :
    ...
    vertex_color(carre, make_color(1, 1, 1));
    push_vertex(carre, 0.0, -0.25, 0);
    push_vertex(carre, 0.5, -0.25, 0);
    push_vertex(carre, 0.5, 0.25, 0);
    push_vertex(carre, 0.0, -0.25, 0);
    push_vertex(carre, 0.5, 0.25, 0);
    push_vertex(carre, 0.0, 0.25, 0);
...
int draw( )
{
    ...
    draw(carre, make_identity(), make_identity(), make_identity());
    Vector v = {-0.52f,0.0f,0.0f};
    Transform m = make_translation(v);
    draw(carre, m, make_identity(), make_identity());
